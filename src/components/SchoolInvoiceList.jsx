                ...
                {leftSchools.map((leftSchool, index) => {
                  ...
                  return (
                    <tr key={leftSchool.id} className={isEven ? "bg-gray-50" : "bg-white"}>
                      <td className="py-2 px-4 border text-[#141516] font-semibold text-[14]">{leftSchool.id}</td>
                      <td className="py-2 px-4 border">
                        <a className="text-[#C01824] underline cursor-pointer font-bold text-[18]" onClick={() => setSchoolData(true)}>{leftSchool.name}</a>
                      </td>
                      <td className="py-2 px-4 border text-[#141516] font-semibold text-[14]">{rightSchool.id}</td>
                      <td className="py-2 px-4 border">
                        <a className="text-[#C01824] underline cursor-pointer font-bold text-[18]">{rightSchool.name}</a>
                      </td>
                    </tr>
                  );
                })}
        ...
        <>
          ...
          <div className="flex justify-center mt-6">
            <nav className="flex gap-1">
              ...
              <button className="px-3 py-1 border rounded bg-[#919EAB]">
