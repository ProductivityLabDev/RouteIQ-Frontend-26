...
import { contactDetails, DriverProfile, studentsData, tripDetails, tripStages } from '@/data'
                                    ...
                                    {selectedInfo === 'Track Drivers' ?
                                        DriverProfile.map(({ name, busNo, imgSrc, role }, index) => (
                                            <div key={index}>
                                                <Button
                                                    ...
                                                    onClick={() => toggleStudentPanel({ busNo, imgSrc, name, role })}
                                                >
                                        ...
                                        : selectedSchoolTab ?
                                            ...
                                            filterStudents().map(({ name, busNo, imgSrc }, index) => (
                                                <div key={index}>
                                                    <Button
                                                        className={`flex items-center gap-3 py-3 pl-4 w-full rounded-none bg-[#fff] transition-all ${selectedStudent?.name === name ? 'bg-[#C01824] text-white' : 'bg-none hover:bg-[#C01824] group'
                                                            }`}
                                ...
                                {selectedStudent?.role === "driver" ?
                                    <div className='flex justify-between'>
                                        ...
                                        <div className="flex items-center flex-col ps-3 gap-2 w-full bg-none">
                                            <img src={selectedStudent.imgSrc} alt={selectedStudent.name} className="rounded-full w-[89px] h-[90px]" />
