export const SEARCH_PAGE_LINKS = [
  ...
  { label: "Edit Profile", description: "Profile settings", path: "/profile", keywords: ["profile", "account", "company", "settings", "vendor details", "school details"] },
...
export const SEARCH_COMMAND_LINKS = [
  ...
  { id: "cmd-edit-profile", label: "Profile", description: "Open profile settings", path: "/profile", keywords: ["my profile", "company profile", "account settings", "school profile"] },
